...
describe(CoordinateUtils, ()=>{
    ...
    describe(CoordinateUtils.createBoxAroundCoord, ()=>{
        describe("should handle valid inputs correctly",()=>{
            let validCases = [
                {coord: new LatLongPair(0,0), radius: 1, result: new BoundingBox(-1,-1,1,1)},
                {coord: new LatLongPair(40.2499,-111.6582), radius: 0.0002, result: new BoundingBox(40.2497,-111.6584,40.2501,-111.6580)}
            ]
